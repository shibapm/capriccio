...
filesWriter.writeSwiftTest(fromFeatures: features, inFolder: destination, generatedClassType: argumets.generatedClassType, disableSwiftLint: argumets.disableSwiftLint, templateFilePath: argumets.templateFilePath, useSingleFile: argumets.useSingleFile)
